...
Tendrás un diccionario llamado ciudades_info que contiene información sobre algunas ciudades, como su país, población y puntos de interés. 
El programa debe permitir al usuario ingresar el nombre de una ciudad y mostrar la información correspondiente. 
El programa debe poder manejar el caso en el que la ciudad no existe en el diccionario y mostrando un mensaje avisando del error.
"""
